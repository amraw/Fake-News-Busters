...
def lstm_model_3(body_length, numb_layers):
    ...
    fake_nn = models.lstm_model_3(headline_length=MAX_HEADLINE_LENGTH,
    ...
    bow_list_data = []
    with open(os.path.join(OBJECT_DUMP, "lstm_headline_body_combine" + str(body_length) + "_" + str(
...
if __name__ == '__main__':
    ...
    lstm_model_3(body_length, numb_layers)